...
<p><b>Câu thứ nhất: tôi đăng nội dung nhiều nhưng không ra đúng khách.</b> Người nói câu này thường đã đăng đều đặn nhiều tháng, có lượt xem, có bình luận, nhưng người nhắn tin lại không phải người có thể trả tiền cho thứ họ bán.</p>
...
<p><b>Câu thứ ba: tuyển thêm người nhưng tôi lại bận hơn trước.</b> Đây là câu làm người chủ hoang mang nhất, vì nó đi ngược hẳn với điều họ mong đợi khi bỏ tiền tuyển người.</p>
...
<p>Đây là phần nhiều người không lường trước. Khi người chủ bán giỏi, doanh thu tăng. Doanh thu tăng thì số việc tăng. Nhưng nếu phần quyết định vẫn chưa rời khỏi đầu người chủ, mỗi việc mới lại tạo thêm một điểm phải chờ họ.</p>
<p>Nói cách khác, doanh thu tăng không tự làm bạn nhẹ đi. Nó chỉ làm cái nút thắt mang tên bạn siết chặt hơn. Và cái nút đó siết đúng vào lúc bạn cần rảnh nhất để nghĩ chuyện lớn.</p>
...
<p>Khi bạn tin vào phễu, bạn xử lý người chưa mua như một thất bại cần cứu. Bạn gọi thêm, nhắn thêm, giảm giá. Và bạn tiêu chính thứ mình cần nhất: sự tin cậy.</p>
...
<p>Một lời khuyên chỉ đường được thì phải có ba thứ: thứ tự, điều kiện đi tiếp, và dấu hiệu cho biết đã xong. Thiếu dấu hiệu hoàn thành thì đó chưa phải chỉ đường, mới chỉ là động viên.</p>
...
<p>Điều quan trọng là nêu cả điều kiện và giới hạn của bài học. Một cách làm hiệu quả trong bối cảnh này có thể sai hoàn toàn trong bối cảnh khác. Người cố vấn nói rõ chỗ đó. Người bán khoá học thì thường bỏ qua.</p>
...
<p>Đây là chỗ tốn tiền nhất mà tôi thấy. Người chủ cảm thấy thương hiệu chưa mạnh, nên tăng tần suất đăng. Đăng ba bài một tuần thành bảy bài. Thuê thêm người viết. Kết quả là cùng một sự mơ hồ, nhưng lan nhanh hơn.</p>
...
<div class="dan-manh">Thương hiệu cá nhân không được xây bằng số lượng bài đăng. Nó được tích luỹ khi đúng người liên tục nhận ra cùng một chuyên môn, cùng một tiêu chuẩn và cùng một cách nhìn qua những bằng chứng thật.</div>
...
<p>Uy tín chỉ làm được một việc: khiến người ta chịu ngồi xuống nghe bạn lần đầu. Từ giây phút đó trở đi, thứ quyết định là chất lượng tư vấn và chất lượng giao hàng. Xây thương hiệu mà không nâng hai thứ kia là xây một cái cửa đẹp dẫn vào phòng trống.</p>
...
<p>Nhưng mỗi lần bạn tự quyết một việc mà không viết lại lý do quyết, bạn tạo thêm một điểm mà chỉ bạn xử lý được. Sau vài năm, những điểm đó nối lại thành một cái nút. Cái nút mang tên bạn.</p>
<p>Điều nguy hiểm là cái nút này không đau khi công ty nhỏ. Nó chỉ đau đúng lúc công ty lớn lên, tức là đúng lúc bạn cần rảnh nhất để nghĩ chuyện lớn.</p>
...
<p><b>Hai, người giỏi trong đội hỏi bạn nhiều hơn năm ngoái.</b> Nghe ngược đời, nhưng khi hệ thống thiếu, người càng có trách nhiệm càng hỏi nhiều, vì họ sợ làm sai.</p>
...
<p>Nhiều người nghe tới đây là đi viết quy trình. Ba tháng sau, có một thư mục đầy tài liệu mà không ai mở. Vì quy trình mô tả các bước, còn thứ đang thiếu là cách nghĩ đằng sau các bước.</p>
<p>Một hệ thống chạy được cần năm thứ, không phải một: kết quả rõ ràng, người chịu trách nhiệm, tiêu chuẩn hoàn thành, dữ liệu để biết đang tốt hay xấu, và một nhịp rà soát cố định.</p>
...
<p>Với luồng đó, viết ra năm thứ ở trên. Chạy sáu tuần. Rà lại. Nếu người phụ trách xử lý được tám trong mười tình huống mà không hỏi bạn, luồng đó đã rời khỏi đầu bạn. Sang luồng tiếp theo.</p>
<p>Một luồng một quý. Bốn luồng một năm. Sau hai năm, cái nút mang tên bạn không còn nữa. Đó là con đường chậm, và tôi chưa thấy con đường nhanh nào thật sự đi tới nơi.</p>
"""),
...
<h2>Năm thứ làm nên một hệ thống</h2>
<p><b>Kết quả rõ ràng.</b> Luồng này tạo ra cái gì, đo bằng gì. Không phải mô tả hoạt động, mà mô tả đầu ra.</p>
...
<p><b>Mức một, chuyển thao tác.</b> Người khác làm được đúng các bước bạn làm. Đây là mức dễ nhất và cũng dễ vỡ nhất, vì gặp tình huống ngoài kịch bản là họ dừng.</p>
...
<p><b>Mức ba, chuyển cách nghĩ.</b> Họ xử lý được tình huống chưa từng có, theo cách bạn thấy chấp nhận được, và giải thích được lý do. Đây là mức duy nhất khiến kinh nghiệm rời hẳn khỏi đầu bạn.</p>
...
<p>Nếu câu trả lời là không, giá trị vẫn đang chảy một chiều từ bạn xuống. Bạn đang gánh toàn bộ, và mô hình đó không lớn được, vì trần của nó là số giờ trong ngày của bạn.</p>

<h2>Giá trị phải được tạo giữa các thành viên</h2>
<p>Cộng đồng thật sự là nơi một thành viên nhận được thứ có ích từ một thành viên khác, chứ không chỉ từ người sáng lập. Có thể là một câu hỏi được trả lời, một lời giới thiệu, một phản hồi thẳng về sản phẩm, hoặc một cơ hội hợp tác.</p>
<p>Việc của người dựng cộng đồng không phải nói nhiều hơn. Việc của họ là thiết kế những dịp để các thành viên hữu ích cho nhau, và giữ tiêu chuẩn để những dịp đó không biến thành chỗ chào hàng.</p>

<div class="dan-manh">Chất lượng thành viên, nhịp tham gia và tiến bộ có bằng chứng quan trọng hơn số người trong nhóm.</div>

<h2>Bốn thứ quyết định một cộng đồng sống hay chết</h2>
...
<p><b>Trải nghiệm bắt đầu.</b> Mười bốn ngày đầu quyết định phần lớn. Người mới cần biết ngay: làm gì trước, gặp ai, và thắng nhỏ đầu tiên là gì.</p>
...
<h2>Đo bằng gì</h2>
<p>Không đo bằng số người trong nhóm. Đo bằng bốn thứ: bao nhiêu người kích hoạt trong mười bốn ngày đầu, bao nhiêu người quay lại theo nhịp, bao nhiêu giá trị được tạo giữa các thành viên, và bao nhiêu người gia hạn hoặc giới thiệu người khác.</p>
...
<p><b>Người nối.</b> Nhớ ai đang làm gì để khi một thành viên nêu vấn đề, người dẫn biết ngay nên nối họ với ai. Đây là vai tạo ra nhiều giá trị nhất và tốn nhiều công nhất, vì nó đòi hỏi thật sự biết từng người.</p>
...
<p>Thay đổi thật cần ba thứ mà khoá học không cho được: thời gian đủ dài để thói quen hình thành, phản hồi lặp lại trên việc thật của chính mình, và những người khác đang đi cùng chặng để so và để hỏi.</p>
...
<p>Chỗ thứ ba là chuyển định dạng. Một bài dài thành dàn ý video, thành mấy đoạn ngắn. Đây là việc lặp lại, đúng chỗ máy giỏi hơn người.</p>
...
<p>Bạn có thể kiểm điều này ở người khác rất nhanh. Đọc một bài của họ, rồi nghe họ nói mười phút. Nếu hai thứ đó là hai người khác nhau, bạn biết ai đang viết.</p>
...
<p><b>Bạn không dám nói câu đó trước một phòng người.</b> Đây là bài kiểm cuối cùng và nghiêm khắc nhất. Nếu bạn ngại đứng lên bảo vệ một câu, đừng để nó mang tên bạn.</p>
...
<p>Thương hiệu cá nhân là một trí nhớ được xây trong đầu người khác. Trí nhớ đó chỉ đậm lên khi cùng một thứ được nhận ra nhiều lần, chứ không phải khi nhiều thứ khác nhau được nhìn thấy nhiều lần.</p>
...
<p><b>Bằng chứng thật.</b> Câu chuyện, quyết định, số liệu, sai lầm từ công việc thật của bạn. Đây là thứ không ai sao chép được, và cũng là thứ hay bị thay bằng lý thuyết chung.</p>
...
<p><b>Mức hai, được nhớ vì một điều.</b> Khi ai đó gặp đúng vấn đề bạn giải, tên bạn bật lên trong đầu họ. Đây là mức mà thương hiệu bắt đầu tạo ra tiền, và cũng là mức phần lớn người làm nội dung không tới được, vì họ đổi hướng trước khi trí nhớ người khác kịp đóng lại.</p>
<p><b>Mức ba, được nhắc lại.</b> Người khác dùng câu của bạn để giải thích cho người thứ ba, dù bạn không có mặt. Đây là lúc thương hiệu tự đi mà không cần bạn đẩy. Từ mức hai lên mức ba thường mất thêm hai tới ba năm, và điều kiện gần như duy nhất là bạn không đổi luận điểm giữa chừng.</p>
...
<p><b>Chưa đủ điều kiện đầu vào.</b> Chương trình cần bạn đã có khách trả tiền, mà bạn chưa có. Nhận vào là hứa một kết quả tôi biết chưa thể xảy ra.</p>
...
<p>Nội dung là công cụ sàng lọc mạnh nhất và rẻ nhất. Khi bạn viết rõ điều mình không làm, những người muốn thứ đó sẽ không liên hệ, và bạn tiết kiệm được hàng chục giờ mỗi quý.</p>
...
dict(tep="lanh-dia-chuyen-mon.html", chu_de="Thương hiệu cá nhân",
 tieu="Lãnh địa chuyên môn: chọn vùng để sở hữu, và vùng để bỏ",
...
<h2>Vì sao nói về nhiều thứ lại là bất lợi</h2>
<p>Thương hiệu cá nhân là một chỗ trong trí nhớ người khác. Trí nhớ đó rất hẹp. Một người bình thường giữ được cho bạn đúng một ô, và ô đó chỉ chứa được một cụm từ.</p>
...
<p>Đây là chỗ nhiều chuyên gia giỏi thua người kém hơn mình. Không phải vì kém chuyên môn, mà vì chuyên môn của họ trải quá rộng để ai đó nhớ nổi.</p>
...
<p><b>Cột một, những gì bạn biết làm.</b> Viết hết, kể cả thứ bạn chỉ làm được ở mức khá. Thường ra mười tới hai mươi mục.</p>
...
<p>Đây là bước hầu như ai cũng né. Viết một câu bắt đầu bằng "tôi không làm về" và điền vào ba thứ mà bạn thật sự làm được nhưng quyết định không nhận nữa.</p>
<p>Cảm giác lúc viết rất khó chịu, vì nó giống như tự đóng cửa cơ hội. Nhưng cơ hội bạn đóng là loại cơ hội lẻ tẻ, còn thứ bạn mở ra là khả năng được nhớ.</p>
...
<p><b>Thứ ba, người ta giới thiệu bạn bằng đúng câu bạn dùng.</b> Đây là dấu hiệu mạnh nhất, và nó chỉ đến sau sáu tới mười hai tháng nói nhất quán.</p>
...
dict(tep="kho-cau-chuyen.html", chu_de="Thương hiệu cá nhân",
 tieu="Kho câu chuyện: biến công việc thật thành chất liệu dùng nhiều năm",
...
<p><b>Sai lầm đã trả giá.</b> Viết được loại này thì bạn có thứ mà mọi khoá học đều thiếu. Điều kiện là bạn phải đủ xa nó để kể mà không cay đắng.</p>
...
<p>Nếu bạn hay nói dễ hơn viết, ghi âm hai phút rồi để máy chuyển thành chữ. Điều quan trọng là khoảng cách giữa lúc xảy ra và lúc ghi phải tính bằng giờ, không phải bằng ngày.</p>
...
<p>Với tôi, kho ghi chép sáu năm là nền của mọi chương trình tôi dạy hôm nay. Không có nó, tôi sẽ dạy lại thứ mình đọc được của người khác.</p>
"""),

dict(tep="nhip-lam-noi-dung.html", chu_de="Thương hiệu cá nhân",
 tieu="Nhịp làm nội dung mà một người vận hành được",
...
<p>Đây không phải vấn đề kỷ luật. Đây là vấn đề thiết kế.</p>
...
<p><b>Khối làm, chín mươi phút một lần mỗi tuần.</b> Đây là khối duy nhất cần đầu óc tỉnh táo. Chọn một mẩu, làm thành nội dung gốc. Đặt lịch cố định và bảo vệ nó như một cuộc hẹn với khách.</p>
<p><b>Khối cắt, sáu mươi phút một lần mỗi tuần.</b> Cắt nội dung gốc thành các mảnh, hẹn giờ đăng. Đây là khối giao được cho người khác hoặc cho AI làm phần lặp lại.</p>
...
<p>Đừng để AI viết nội dung gốc từ số không. Bạn sẽ tiết kiệm được chín mươi phút và mất thứ duy nhất không ai sao chép được.</p>

<h2>Đo bằng gì để không tự lừa mình</h2>
<p>Không đo bằng lượt xem tuần này. Đo bằng ba thứ chậm hơn nhưng thật hơn.</p>
<p>Một, số tuần liên tiếp bạn giữ được nhịp. Đây là chỉ số quan trọng nhất trong sáu tháng đầu.</p>
...
dict(tep="chan-doan-truoc-khi-ke-don.html", chu_de="Quan hệ với khách",
 tieu="Chẩn đoán trước khi kê đơn: cấu trúc một buổi tư vấn",
...
<p>Việc của phần này không phải làm quen. Việc của nó là thống nhất buổi hôm nay dùng để làm gì và kết thúc thế nào.</p>
...
<p>Đây là phần dài nhất và là phần quyết định. Bạn cần ba lớp thông tin.</p>
...
<p>Nói lại bằng lời của bạn điều bạn nghe được, và nêu nguyên nhân sâu hơn mà họ chưa gọi tên. Đây là khoảnh khắc quyết định niềm tin.</p>
...
dict(tep="de-toi-suy-nghi-them.html", chu_de="Quan hệ với khách",
 tieu="Khách nói để tôi suy nghĩ thêm, nghĩa thật là gì",
...
<p>Có một trường hợp câu đó mang nghĩa đen: khi quyết định này ảnh hưởng tới người khác trong doanh nghiệp và họ cần trao đổi nội bộ. Lúc đó việc của bạn không phải chờ, mà là trang bị cho họ.</p>
...
dict(tep="vi-sao-giam-gia-lam-hong-quan-he.html", chu_de="Quan hệ với khách",
 tieu="Vì sao giảm giá làm hỏng quan hệ, không chỉ làm giảm lợi nhuận",
 ...
 anh="img/founder-nam-1.webp", alt="Ảnh minh hoạ một nhà sáng lập",
 than="""
<p>Người ta thường tính cái giá của việc giảm giá bằng phần trăm lợi nhuận mất đi. Cách tính đó bỏ qua phần đắt nhất, là thứ xảy ra trong đầu khách sau khi bạn giảm.</p>
...
<p><b>Điều ba: bạn cần họ hơn họ cần bạn.</b> Đây là điều tệ nhất, vì nó đảo vị thế. Mà trong dịch vụ tư vấn, vị thế quyết định việc lời khuyên của bạn có được nghe hay không.</p>
...
<p>Nghe ngược đời nhưng tôi thấy đúng gần như mọi lần. Người trả đủ giá đã tự thuyết phục mình rằng việc này quan trọng, nên họ có mặt, làm bài, và hỏi những câu sâu.</p>
...
<p>Nói cách khác, giảm giá không chỉ giảm doanh thu. Nó tăng khả năng bạn có một trường hợp thất bại để đời.</p>
...
<p><b>Giảm theo một quy tắc áp dụng cho tất cả</b>, ví dụ đăng ký sớm. Điều làm hỏng quan hệ không phải con số thấp hơn, mà là con số thấp hơn dành riêng cho người biết mặc cả.</p>
...
<p>Câu này giữ được ba thứ cùng lúc: giá, sự tôn trọng với khách cũ, và cửa để đi tiếp.</p>
"""),

dict(tep="nam-thu-lam-nen-mot-he-thong.html", chu_de="Hệ thống và đội ngũ",
 tieu="Năm thứ làm nên một hệ thống chạy được",
...
<h2>Năm thứ, thiếu một là hỏng</h2>

<h3>Một: kết quả rõ ràng</h3>
<p>Luồng này tạo ra cái gì, đo bằng gì. Đây phải là mô tả đầu ra, không phải mô tả hoạt động.</p>
...
<p>Làm thế nào thì gọi là xong và đủ tốt. Thiếu cái này, mỗi người hiểu chữ xong một kiểu, và người chủ trở thành trọng tài cho mọi việc.</p>
<p>Tiêu chuẩn tốt nhất là thứ kiểm được bằng mắt trong ba mươi giây, không phải một đoạn văn mô tả chất lượng.</p>
...
<p>Bao lâu ngồi lại một lần để sửa. Đây là thứ hay bị bỏ nhất và cũng là thứ giết hệ thống nhanh nhất khi thiếu.</p>
...
<div class="dan-manh">Một hệ thống không phải một tập tài liệu. Nó là kết quả rõ, người chịu trách nhiệm, tiêu chuẩn, dữ liệu và nhịp cải tiến. Quy trình chỉ là cách ghi lại bốn thứ kia.</div>
...
dict(tep="muoi-bon-ngay-dau.html", chu_de="Cộng đồng",
 tieu="Mười bốn ngày đầu quyết định phần lớn",
 mo="Người mới vào cộng đồng quyết định ở lại hay không trong hai tuần đầu, và họ quyết dựa trên việc có đạt được một thắng nhỏ hay không.",
 ngay="2026-07-16", ngay_viet="16 tháng 7, 2026", doc="6 phút đọc",
 anh="img/founder-nu-2.webp", alt="Ảnh minh hoạ một nhà sáng lập",
 than="""
<p>Trong mọi cộng đồng tôi từng quan sát, tỉ lệ người còn hoạt động sau sáu tháng gần như được định đoạt trong hai tuần đầu. Người có một thắng nhỏ trong mười bốn ngày đầu thì ở lại. Người không có thì âm thầm rời đi, thường không nói gì.</p>
...
<p>Điều nhiều người dựng cộng đồng hiểu sai: họ nghĩ nội dung hay sẽ giữ người. Nội dung hay chỉ giữ được sự chú ý. Thứ giữ người là cảm giác mình đang tiến bộ.</p>

<div class="dan-manh">Thắng nhỏ không phải phần thưởng. Nó là bằng chứng cho người mới rằng chỗ này làm được việc, và rằng chính họ làm được việc.</div>
...
<p>Đây là phần đáng đầu tư nhất và thường bị coi là phần phụ. Nếu bạn chỉ có thời gian làm tốt một thứ trong cộng đồng của mình, hãy làm tốt mười bốn ngày đầu.</p>
...
dict(tep="do-cong-dong-bang-gi.html", chu_de="Cộng đồng",
 tieu="Đo cộng đồng bằng gì ngoài số người",
...
<h3>Một: tỉ lệ kích hoạt trong mười bốn ngày đầu</h3>
<p>Bao nhiêu phần trăm người mới làm được ít nhất một việc thật trong hai tuần đầu. Đây là chỉ số dự báo mạnh nhất cho việc họ còn ở lại sau sáu tháng.</p>
...
<p>Đây là con số trung thực nhất, vì nó tốn tiền hoặc tốn uy tín của người bỏ phiếu. Người ta không giới thiệu bạn bè vào một chỗ mà chính họ thấy nhạt.</p>

<div class="dan-manh">Chất lượng thành viên, nhịp tham gia và tiến bộ có bằng chứng quan trọng hơn số người trong nhóm.</div>

<h2>Bài kiểm hai tuần</h2>
<p>Có một bài kiểm rẻ và tàn nhẫn: ngừng đăng trong hai tuần và xem chuyện gì xảy ra.</p>
<p>Nếu cộng đồng vẫn có hoạt động, giá trị đang được tạo giữa các thành viên. Nếu im lặng hoàn toàn, bạn đang gánh toàn bộ, và mô hình đó có trần là số giờ trong ngày của bạn.</p>
...
<tr><td>Tỉ lệ kích hoạt 14 ngày</td><td>Dưới 40 phần trăm</td></tr>
...
<p>Các ngưỡng này là điểm khởi đầu để bạn có cái mà so, không phải chuẩn ngành. Điều quan trọng là bạn đo cùng một cách qua nhiều tháng, để thấy xu hướng chứ không phải một lát cắt.</p>

<h2>Đo để làm gì</h2>
<p>Không phải để báo cáo. Để biết sửa chỗ nào. Kích hoạt thấp thì sửa mười bốn ngày đầu. Quay lại thấp thì sửa nhịp. Giá trị giữa thành viên thấp thì sửa cơ chế kết nối. Gia hạn thấp thì xem lại lời hứa ban đầu có được giữ không.</p>
"""),
